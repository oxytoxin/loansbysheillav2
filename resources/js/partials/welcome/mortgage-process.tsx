export default function MortgageProcess() {
    ...
    return (
        <div className="bg-card relative z-10 mx-auto my-32 flex max-w-10/12 flex-col rounded-lg p-12 md:p-16">
            <h2 className="heading">Our Mortgage Process</h2>
            <div className="flex items-stretch justify-between gap-8">
                <div className="lg:flex-3/5 md:p-12">
                            ...
                            <div key={index} className="relative flex items-center gap-4 pb-12">
                                <div className="relative hidden lg:block flex-shrink-0">
                                    ...
                                    {index !== steps.length - 1 && (
                                        <div
                                            className="bg-primary  absolute top-0 left-1/2 h-[calc(100%+5rem)] w-0.5 -translate-x-1/2"></div>
                                    )}
                                </div>
                                <div className="md:text-2xl font-medium">{step}</div>
                            </div>
                        ))}
                    </div>
                </div>
                <div className="hidden lg:block flex-2/5">
                    <img src="/images/process.png" alt="Mortgage Process"
                         className="h-full rounded-lg object-cover object-right shadow-lg"/>
                </div>
            </div>
        </div>
    );
