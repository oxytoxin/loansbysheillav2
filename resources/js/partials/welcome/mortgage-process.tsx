    ...
    return (
        <div className="bg-card relative z-10 mx-auto my-32 flex max-w-10/12 flex-col gap-16 rounded-lg p-16">
            ...
            <div className="flex items-stretch justify-between gap-8">
                <div className="flex-3/5 py-12">
                    <div className="relative">
                        {steps.map((step, index) => (
                            <div key={index} className="relative flex items-center gap-4 pb-16">
                                <div className="relative flex-shrink-0">
                                    <div className="bg-primary z-10 h-4 w-4 rounded-full"></div>
                                    {index !== steps.length - 1 && (
                                        <div className="bg-primary absolute top-4 left-1/2 h-[calc(100%+4.5rem)] w-0.5 -translate-x-1/2"></div>
                                    )}
                                </div>
                ...
                <div className="flex-2/5">
                    <img
                        ...
                        className="h-full object-cover object-right rounded-lg shadow-lg"
                    />
                </div>
            </div>
        </div>
