...
export default function WhatWeCanOffer() {
    return (
        <div id='services' className="mt-16">
            ...
            <div className="lg:px-64 md:px-16 px-4">
                <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div>
                            <div className="flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <div className="mt-4">
                                        <p>At <strong className="text-primary font-bold">Loans by Sheilla, LLC</strong>, we are dedicated to delivering attentive and responsive service at every stage of the loan process.</p>
                                        <p className="mt-4">
                                ...
                                <div>
                                    ...
                                    <div className="mt-4">
                                        <p>
                                            ...
                                            and options for<span className="text-primary font-bold">&nbsp;rate-and-term&nbsp;</span>or
                    ...
                    <div className="flex flex-1 flex-col">
                        ...
                        <a href="/#contact" className="bg-primary mt-2 self-start rounded-full px-4 py-2 font-bold text-white">Contact Now</a>
                        <img className="mt-8 hidden lg:block flex-1 rounded-xl object-cover object-center" src="/images/offer-2.png" alt=""/>
                    </div>
                </div>
            </div>
        </div>
