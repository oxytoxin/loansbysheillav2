    ...
    return (
        <>
            ...
            <div className="relative flex flex-col items-center">
                ...
                <img src="/images/sl-3.png" alt="" className="absolute pointer-events-none right-0 bottom-0 h-[115%] w-auto" />

                <div className="absolute top-32 left-32 z-10 flex flex-col justify-center">
                    ...
                    <ul className="mt-12 flex items-center gap-12 text-xl font-semibold">
                        <li>
                            <Link className="bg-secondary hover:bg-accent rounded-full px-16 py-4 text-2xl font-bold text-primary transition duration-300" href="/">
                                Request a Quote
                            </Link>
                        </li>
                        <li>
                ...
                <div className="bg-primary/90 absolute right-0 bottom-40 z-10 flex gap-8 rounded-l-full text-xs px-20 py-6  text-white">
