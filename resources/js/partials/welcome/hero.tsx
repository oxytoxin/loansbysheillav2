...
export default function Hero() {
    return (
        <div className="relative mx-32 mt-12 flex flex-col items-center">
            <div className="w-full">
                <img
                    className="max-h-[42rem] w-full rounded-2xl object-cover"
            ...
            <div className="absolute top-24 left-32 z-10 flex flex-col justify-center">
                ...
                <ul className="mt-12 flex items-center gap-4 text-xl font-semibold">
                    <li>
                        <Link className="bg-secondary hover:bg-accent rounded-full px-6 py-2 text-black transition duration-300" href="/">
                            Request a Quote
                        </Link>
                    </li>
                    <li>
                        <Link className="rounded-full bg-[#C1FF72] px-6 py-2 text-black transition duration-300 hover:bg-[#F4F5F8]" href="/">
                            Ready to Apply
                        </Link>
                    </li>
                </ul>
            </div>
            <div className="bg-primary absolute right-0 bottom-0 z-10 flex gap-8 rounded-2xl px-8 py-2 text-sm text-white">
